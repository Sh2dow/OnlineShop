(function () {
    ...
    templateEngine.addTemplate("ko_simpleGrid_pageLinks", "\
                    <div class=\"ko-grid-pageLinks\">\
                        ...
                        <div class='pull-right'><nav><ul class='pager'><li class='active-pager' data-bind='css:{disabled:currentPageIndex() === 0},click: currentPageIndex()=== 0 ? function(){return false;} : function(){currentPageIndex(currentPageIndex()-1)}'><a href='#'  class='glyphicon-chevron-left' aria-hidden='true' aria-label='previous'></a></li><li class='active-pager' data-bind='css:{disabled: currentPageIndex()=== maxPageIndex()},click: currentPageIndex()=== maxPageIndex()?function(){return false;}:function(){currentPageIndex(currentPageIndex()+1)}'><a href='#' class='glyphicon-chevron-right' aria-hidden='true' aria-label='next'></a></li></ul></nav></div>\
                    </div>");
